...
has been known and analyzed for years -- polyalphabetic substitution
with a running key stream, also known as a stream cipher.
...
polyalphaabetic substitution ciphers.
