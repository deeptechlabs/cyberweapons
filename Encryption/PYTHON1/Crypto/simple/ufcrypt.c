...
static unsigned long keytab[16][2];
...
static unsigned long sb0[8192],sb1[8192],sb2[8192],sb3[8192];
...
static char *output_conversion(l1,l2,r1,r2,salt)
...
static object *ufcrypt_crypt(self, args)
	object *self, *args;
{
	char *word, *salt; 
	...
	return newstringobject( ufcrypt( word, salt ) );

}

static struct methodlist ufcrypt_methods[] = {
	{"crypt",	ufcrypt_crypt},
	{NULL,		NULL}		/* sentinel */
};
...
initufcrypt()
{
	initmodule("ufcrypt", ufcrypt_methods);
      init_des();
}
