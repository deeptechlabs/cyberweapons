...
#define DIGIT_4MSB(x) (unsigned int)(((x) >> (NN_DIGIT_BITS - 4)) & 15)
...
#define USE_MONT	1	/* use Montgomery multiplication */

#ifndef USE_MONT
#define USE_2MODEXP 1	/* use special-case modexp */
#endif
