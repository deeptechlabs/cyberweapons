...
begin
 ...
 {If you are using Delphi 1.02 you can test the output from the component
  against the C DLL(16bit) which is included.}
...
begin
 ...
 try
  ...
  SetString(dumstr, inStr, 8);
  Label4.Caption := dumStr;
