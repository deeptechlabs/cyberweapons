...
NMAKEBSC2  = nmake
CC  = cl
CFLAGS_G  = /AL /W2 /Za /DPROTOTYPES=1 /DTESTDOS386 /DRIPEMSIG /BATCH
CFLAGS_D  = /f /Od /Zi
...
FILES  = ADDUSER.C BEMPARSE.C CERTUTIL.C CRACKHED.C DERKEY.C \
		  GETOPT.C GETSYS.C HEXBIN.C\
...
OBJS    = ADDUSER.obj BEMPARSE.obj CERTUTIL.obj CRACKHED.obj DERKEY.obj \
		  GETOPT.obj GETSYS.obj\
		  HEXBIN.obj KEYDER.obj KEYMAN.obj LIST.obj MSC7.obj PARSIT.obj\
		  PRENCODE.obj RDWRMSG.obj RIPEMMAI.obj STRUTIL.obj\
		  USAGE.obj USAGEMSG.obj RIPEMSOC.obj PUBINFO.obj PROCTYPE.obj
LIBS_EXT  = ..\rsaref\test\rsaref.lib
LIBS    = $(LIBS_EXT)
SBRS    = ADDUSER.sbr BEMPARSE.sbr CERTUTIL.sbr CRACKHED.sbr DERKEY.sbr \
		  GETOPT.sbr GETSYS.sbr\
		  HEXBIN.sbr KEYDER.sbr KEYMAN.sbr LIST.sbr MSC7.sbr PARSIT.sbr\
		  PRENCODE.sbr RDWRMSG.sbr RIPEMMAI.sbr STRUTIL.sbr\
		  USAGE.sbr USAGEMSG.sbr RIPEMSOC.sbr PUBINFO.sbr
...
ADDUSER.sbr : ADDUSER.C global.h ..\rsaref\source\rsaref.h ripem.h list.h\
		  listprot.h strutilp.h keyfield.h
!IF $(DEBUG)
		  @$(CC) @<<$(PROJ).rsp
/Zs $(CFLAGS_G)
...
CERTUTIL.sbr : CERTUTIL.C 
!IF $(DEBUG)
		  @$(CC) @<<$(PROJ).rsp
/Zs $(CFLAGS_G)
$(CFLAGS_D) /FRCERTUTIL.sbr CERTUTIL.C
<<
!ELSE
		  @$(CC) @<<$(PROJ).rsp
/Zs $(CFLAGS_G)
$(CFLAGS_R) /FRCERTUTIL.sbr CERTUTIL.C
<<
!ENDIF
...
CERTUTIL.obj : CERTUTIL.C global.h ..\rsaref\source\rsaref.h ripem.h\
		  headers.h  prcodepr.h  keyderpr.h keymanpr.h p.h\
		  list.h keyfield.h certder.h rdwrmsgp.h pubinfop.h certutil.h 
!IF $(DEBUG)
		  @$(CC) @<<$(PROJ).rsp
/c $(CFLAGS_G)
$(CFLAGS_D) /FoCERTUTIL.obj CERTUTIL.C
<<
!ELSE
		  @$(CC) @<<$(PROJ).rsp
/c $(CFLAGS_G)
$(CFLAGS_R) /FoCERTUTIL.obj CERTUTIL.C
<<
!ENDIF

CRACKHED.sbr : CRACKHED.C global.h ..\rsaref\source\rsaref.h ripem.h\
		  ripemglo.h prcodepr.h crackhpr.h strutilp.h hexbinpr.h derkeypr.h\
		  list.h keyfield.h
!IF $(DEBUG)
		  @$(CC) @<<$(PROJ).rsp
...
DERKEY.sbr : DERKEY.C global.h ..\rsaref\source\rsaref.h ripem.h\
		  derkeypr.h list.h keyfield.h
!IF $(DEBUG)
		  @$(CC) @<<$(PROJ).rsp
/Zs $(CFLAGS_G)
...
GETSYS.sbr : GETSYS.C global.h ..\rsaref\source\rsaref.h ripem.h\
		  getsyspr.h strutilp.h list.h keyfield.h
!IF $(DEBUG)
		  @$(CC) @<<$(PROJ).rsp
/Zs $(CFLAGS_G)
...
KEYDER.sbr : KEYDER.C global.h ..\rsaref\source\rsaref.h ripem.h\
		  keyderpr.h list.h keyfield.h
!IF $(DEBUG)
		  @$(CC) @<<$(PROJ).rsp
/Zs $(CFLAGS_G)
...
KEYMAN.obj : KEYMAN.C global.h ..\rsaref\source\rsaref.h\
		  ..\rsaref\source\md5.h ripem.h ripemglo.h keymanpr.h\
...
KEYMAN.sbr : KEYMAN.C global.h ..\rsaref\source\rsaref.h\
		  ..\rsaref\source\md5.h ripem.h ripemglo.h keymanpr.h\
		  strutilp.h derkeypr.h prcodepr.h hexbinpr.h getsyspr.h ripemsop.h\
		  pubinfop.h keyderpr.h bemparse.h list.h keyfield.h
!IF $(DEBUG)
...
RDWRMSG.sbr : RDWRMSG.C global.h ..\rsaref\source\rsaref.h ripem.h\
		  ripemglo.h rdwrmsgp.h strutilp.h listprot.h adduserp.h list.h\
		  keyfield.h
!IF $(DEBUG)
		  @$(CC) @<<$(PROJ).rsp
...
RIPEMMAI.sbr : RIPEMMAI.C global.h ..\rsaref\source\rsaref.h ripem.h\
		  ripemglo.h prcodepr.h usagepro.h getoptpr.h  ripempro.h\
		  getsyspr.h strutilp.h keyderpr.h derkeypr.h keymanpr.h listprot.h\
		  adduserp.h r_random.h bemparse.h hexbinpr.h crackhpr.h rdwrmsgp.h\
		  parsitpr.h p.h list.h keyfield.h
!IF $(DEBUG)
		  @$(CC) @<<$(PROJ).rsp
/Zs $(CFLAGS_G)
...
RIPEMSOC.sbr : RIPEMSOC.C global.h ..\rsaref\source\rsaref.h ripem.h\
		  ripemsop.h ripemglo.h keyfield.h protserv.h list.h
!IF $(DEBUG)
		  @$(CC) @<<$(PROJ).rsp
/Zs $(CFLAGS_G)
