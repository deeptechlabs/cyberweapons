...
int main(void)
{
  long KD[ROUNDS][2], KE[ROUNDS][2], M[2], c[2];
  long C1[2] = {0x85e81354l, 0x0f0ab405l};
  long C2[2] = {0x3fa40e8al, 0x984d4815l};
  long m[2] = {0x01234567l, 0x89abcdefl};
  long key[2] = {0x13345779l, 0x9bbcdff1l};

  #ifdef DEBUG
  printf("m[0] = %8lx\nm[1] = %8lx\n\n", m[0], m[1]);
  #endif
  DES_key_schedule(KE, key);
  DES(KE, m, c);
  printf("\nthe message is:\n");
  printf("%8lx %8lx\n", m[0], m[1]);
