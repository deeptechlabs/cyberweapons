...
void ideaCrypt( BYTE const *in, BYTE *out, word16 const *key )
	...
	register LONG t32;		/* Needed by mul() macro */
...
void main( void )
	{
	BYTE key[] = { 0x00, 0x01, 0x00, 0x02, 0x00, 0x03, 0x00, 0x04,
				   0x00, 0x05, 0x00, 0x06, 0x00, 0x07, 0x00, 0x08 };
	BYTE plain[] = { 0x00, 0x00, 0x00, 0x01, 0x00, 0x02, 0x00, 0x03 };
	BYTE cipher[] = { 0x11, 0xFB, 0xED, 0x2B, 0x01, 0x98, 0x6D, 0xE5 };
	BYTE temp[ 8 ] = { 0 };
